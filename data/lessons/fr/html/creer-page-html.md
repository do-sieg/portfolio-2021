...
![_EXPAND_Dossier du projet](/images/learn/html/html-working-directory.png)
...
![_EXPAND_Créer un fichier HTML (1)](/images/learn/html/html-create-file-1.png)

Nous allons le renommer, ainsi que son **extension**.

![_EXPAND_Créer un fichier HTML (2)](/images/learn/html/html-create-file-2.png)
...
![_EXPAND_Créer un fichier HTML (3)](/images/learn/html/html-create-file-3.png)
...
![_EXPAND_Créer un fichier HTML (4)](/images/learn/html/html-create-file-4.png)
...
![_EXPAND_Écrire un texte dans la page HTML (1)](/images/learn/html/html-write-first-text-1.png)
...
![_EXPAND_Écrire un texte dans la page HTML (2)](/images/learn/html/html-write-first-text-2.png)
...
![_EXPAND_Écrire un texte dans la page HTML (3)](/images/learn/html/html-write-first-text-3.png)
